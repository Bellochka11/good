...
public class Transport {
    ...
    public void setValues(float speed, int weight, String color, byte[] coordinate){ //setValues - установка значений
        this.speed = speed; //this - значит что я обращаюсь к классу Transport и вытягиваю из него что-либо
        this.weight = weight;
        this.color = color;
        this.coordinate = coordinate;
    }
    public String getValues(){ //getValues - получение значений. ВЫВОД В ТЕРМИНАЛ
